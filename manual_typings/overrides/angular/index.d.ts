// This is overridden angular type definition, so we can use it without importing, because we don't use angular directly
...
declare namespace ng {
  ...
  export module auto {
    ...
    interface IProvideService {
      ...
      factory(...args: ProvideSpreadType[]): ng.IServiceProvider;
      provider(...args: ProvideSpreadType[]): ng.IServiceProvider;
      service(...args: ProvideSpreadType[]): ng.IServiceProvider;
      value(...args: ProvideSpreadType[]): ng.IServiceProvider;
    }
